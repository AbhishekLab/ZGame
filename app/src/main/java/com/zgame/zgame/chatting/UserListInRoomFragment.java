...
public class UserListInRoomFragment extends Fragment {
    ...
    private List<ChatUserModel> userModels;
    private RecyclerView recyclerView;

    public UserListInRoomFragment() {
    }

    public static final UserListInRoomFragment getInstance(String roomID, Map<String, ChatUserModel> userModels) {
        List<ChatUserModel> users = new ArrayList();
        for( Map.Entry<String, ChatUserModel> elem : userModels.entrySet() ){
    ...
    public void setUserList(List<ChatUserModel> users) {
        userModels = users;
    }
