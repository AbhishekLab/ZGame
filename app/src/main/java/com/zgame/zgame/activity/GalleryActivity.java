...
public class GalleryActivity extends BaseActivity<ActivityGalleryBinding> implements OnPhotoEditorListener,
    ...
    public static final int READ_WRITE_STORAGE = 53;
        ...
        switch (view.getId()) {
            ...
            case R.id.imgSave:{
               ...
               permission.add(Manifest.permission.WRITE_EXTERNAL_STORAGE);
                requestAppPermissions(permission.toArray(new String[permission.size()]), R.string.permission_text, Constant.STORAGE_PERMISSION);
                break;
            }
